          ...
          >
              ...
              <div className="flex items-stretch gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="group flex items-center gap-3 cursor-target relative overflow-hidden rounded-xl border border-white/[0.07] bg-white/[0.03] hover:bg-white/[0.06] backdrop-blur-sm px-4 py-3 transition-all duration-300 hover:border-blue-400/30 hover:shadow-[0_0_24px_-4px_rgba(59,130,246,0.25)]">
                    ...
                    <div className="flex flex-col gap-0.5">
                      <div className="flex items-center gap-2">
                        <span className="text-[11px] font-mono uppercase tracking-widest text-blue-400/80 leading-none">
                          M.S.
                        </span>
                        <span className="text-[10px] text-blue-400/40 leading-none">
                          •
                        </span>
                        <span className="text-[11px] font-mono tracking-widest text-blue-400/60 leading-none">
                          2025–2027
                        </span>
                      </div>
                      <span className="text-white/90 font-medium text-sm leading-tight tracking-tight">
                        Advanced Computing
                      </span>
                      <span className="text-slate-500 text-[10px] font-mono uppercase tracking-wider leading-none">
                        Tsinghua · 清华大学
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-center gap-3 cursor-target relative overflow-hidden rounded-xl border border-white/[0.07] bg-white/[0.03] hover:bg-white/[0.06] backdrop-blur-sm px-4 py-3 transition-all duration-300 hover:border-cyan-400/30 hover:shadow-[0_0_24px_-4px_rgba(34,211,238,0.2)]">
                    ...
                    <div className="flex flex-col gap-0.5">
                      <div className="flex items-center gap-2">
                        <span className="text-[11px] font-mono uppercase tracking-widest text-cyan-400/80 leading-none">
                          B.Sc.
                        </span>
                        <span className="text-[10px] text-cyan-400/40 leading-none">
                          •
                        </span>
                        <span className="text-[11px] font-mono tracking-widest text-cyan-400/60 leading-none">
                          2021–2025
                        </span>
                      </div>
                      <span className="text-white/90 font-medium text-sm leading-tight tracking-tight">
            ...
            <p className="leading-relaxed text-sm md:text-base font-light text-slate-400 tracking-wide max-w-lg mt-6 font-sans">
              ...
              <span className="font-bold">
                Tsinghua Key Laboratory of Pervasive Computing
              </span>
              , focusing on Vision Language Models (VLMs), Multimodal AI, and
              Human-Computer Interaction (HCI). Awarded{' '}
              <span className="bg-gradient-to-tr from-[#BF953F] via-[#FCF6BA] to-[#B38728] bg-clip-text text-transparent font-bold">
                3 gold
              </span>{' '}
              and{' '}
              <span className="bg-gradient-to-tr from-[#9ca3af] via-[#f3f4f6] to-[#4b5563] bg-clip-text text-transparent font-bold">
                4 silver
              </span>{' '}
              medals in competitive machine learning, with research
              contributions published at international venues such as
              LLM2KG@ESWC and ISRITI.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 overflow-visible pointer-events-none z-0">
                <svg
                  className="absolute -top-3 left-8 w-2 h-2 text-blue-300 animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
                ...
                <svg
                  className="absolute bottom-1 -right-2 w-2.5 h-2.5 text-blue-200 animate-[pulse_1.5s_ease-in-out_infinite] opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
                  <path d="M12 0C12 6.627 17.373 12 24 12C17.373 12 12 17.373 12 24C12 17.373 6.627 12 0 12C6.627 12 12 6.627 12 0Z" />
                ...
                <svg
                  className="absolute top-2 -right-4 w-1.5 h-1.5 text-white animate-[pulse_2s_ease-in-out_infinite] opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-300"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
                  <path d="M12 0C12 6.627 17.373 12 24 12C17.373 12 12 17.373 12 24C12 17.373 6.627 12 0 12C6.627 12 12 6.627 12 0Z" />
                ...
                <svg
                  className="absolute -bottom-4 left-12 w-1.5 h-1.5 text-blue-400 animate-[pulse_2.5s_ease-in-out_infinite] opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
                  <path d="M12 0C12 6.627 17.373 12 24 12C17.373 12 12 17.373 12 24C12 17.373 6.627 12 0 12C6.627 12 12 6.627 12 0Z" />
                ...
                <span className="iconify solar--letter-linear w-6 h-6">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="1.5"
                      d="M22 12c0-4.714 0-7.071-1.465-8.535C19.072 2 16.714 2 12 2S4.928 2 3.465 3.465C2 4.928 2 7.286 2 12s0 7.071 1.465 8.535C4.928 22 7.286 22 12 22s7.071 0 8.535-1.465C22 19.072 22 16.714 22 12Z"
                    />
                    <path
                      fill="none"
                      stroke="currentColor"
                      ...
                      strokeLinejoin="round"
                      strokeWidth="1.5"
                      d="m2 7l7.5 4.5a5 5 0 0 0 5 0L22 7"
                    />
                  </svg>
                </span>
              </a>
              ...
              >
                <span className="w-6 h-6 inline-flex">
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M20.45 20.45h-3.56v-5.57c0-1.33-.03-3.03-1.85-3.03c-1.86 0-2.14 1.45-2.14 2.94v5.66H9.34V9h3.42v1.56h.05c.48-.9 1.64-1.85 3.37-1.85c3.6 0 4.27 2.37 4.27 5.46v6.28ZM5.34 7.43a2.06 2.06 0 1 1 0-4.12a2.06 2.06 0 0 1 0 4.12ZM7.12 20.45H3.56V9h3.56v11.45Z"
                    />
                  </svg>
                </span>
              </a>
              ...
              >
                <span className="w-6 h-6 inline-flex">
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M12 3L1 9l11 6l9-4.91V17h2V9L12 3Zm0 9.75L4.74 9L12 5.25L19.26 9L12 12.75ZM5 13.66V17c0 2.21 3.13 4 7 4s7-1.79 7-4v-3.34L12 17.5L5 13.66Z"
                    />
                  </svg>
                </span>
              </a>
              ...
              <span className="text-[10px] font-mono uppercase tracking-widest text-white whitespace-nowrap">
                <Typewriter
                  options={{
                    strings: [
                      'Bing chilling...',
                      'Sigma grindset loading...',
                      'No cap fr fr...',
                      'Glazing the codebase...',
                      'Eating gyatt for breakfast...',
                      'Skibidi compiling...',
                      'Rizzing up the API...',
                      'NPC behavior detected...',
                      'Touching grass.exe failed...',
                      'Caught in 4K...',
                    ],
                    autoStart: true,
                    loop: true,
