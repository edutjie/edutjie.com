...
export const ProjectModal: React.FC<ProjectModalProps> = ({ project, onClose, isAchievement }) => {
  ...
  return (
    ...
    >
      {/* Header Controls */}
      <div className="fixed top-0 left-0 w-full p-4 md:p-6 pt-24 md:pt-6 flex justify-between z-[110] pointer-events-none">
        ...
        <div className="w-full h-[60vh] md:h-[80vh] relative">
          ...
          <div className="absolute bottom-0 left-0 w-full p-6 md:p-12 pb-12">
            <div className="overflow-visible pr-4">
              <h1
                id="modal-title"
                className="font-display text-xl md:text-5xl lg:text-7xl text-white transform -rotate-1 origin-bottom-left drop-shadow-2xl leading-tight py-2"
              >
                {project.name}
              </h1>
            </div>
