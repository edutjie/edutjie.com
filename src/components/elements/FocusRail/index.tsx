...
export function FocusRail({
    ...
    return (
        <div
            className={cn(
                "group relative flex min-h-[700px] md:min-h-[600px] md:h-[600px] w-full flex-col overflow-hidden bg-transparent text-white outline-none select-none overflow-x-hidden py-8 md:py-0",
                className
            )}
        ...
        >
            ...
            <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
                ...
                <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
                    <div className="flex flex-1 flex-col items-center text-center md:items-start md:text-left min-h-[8rem] md:h-32 justify-center">
